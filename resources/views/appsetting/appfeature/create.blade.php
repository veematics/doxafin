        ...
        <div class="container-lg">
            <div class="card mb-4">
                <div class="card-header">
                    <strong>Create New Feature</strong>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('appsetting.appfeature.store') }}">
                        @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <i id="selectedIconPreview" class="cil-apps"></i>
                                        </span>
                                        <input class="form-control @error('featureIcon') is-invalid @enderror" 
                                               id="featureIcon"
                                               type="text"
                                               name="featureIcon"
                                               value="{{ old('featureIcon') }}"
                            ...
                            <div class="col-sm-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="cil-save"></i> Create Feature
                                    </button>
                                </div>
                            </div>
                        </div>
